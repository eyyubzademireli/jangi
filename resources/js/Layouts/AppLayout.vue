            ...
            <nav class="bg-white border-b border-gray-100">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <JetNavLink :href="route('composer')" :active="route().current('composer')">
                                    Məlumatlar
                                </JetNavLink>
                                <JetNavLink :href="route('media')" :active="route().current('media')">
                                    Media
                                </JetNavLink>
                                <JetNavLink :href="route('events')" :active="route().current('events')">
                                    Tədbirlər
                                </JetNavLink>
                                <JetNavLink :href="route('awards')" :active="route().current('awards')">
                                    Mükafatlar
                                </JetNavLink>
                                <JetNavLink :href="route('about')" :active="route().current('about')">
                                    Haqqımızda
                                </JetNavLink>
                                <JetNavLink :href="route('teams')" :active="route().current('teams')">
                                    Komandamız
                                </JetNavLink>
                            </div>
                        </div>
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                    <div class="pt-2 pb-3 space-y-1">
                        <JetResponsiveNavLink :href="route('composer')" :active="route().current('composer')">
                            Məlumatlar
                        </JetResponsiveNavLink>
                        <JetResponsiveNavLink :href="route('media')" :active="route().current('media')">
                            Media
                        </JetResponsiveNavLink>
                        <JetResponsiveNavLink :href="route('events')" :active="route().current('events')">
                            Tədbirlər
                        </JetResponsiveNavLink>
                        ...
                        <JetResponsiveNavLink :href="route('teams')" :active="route().current('teams')">
                            Komandamız
                        </JetResponsiveNavLink>
                    </div>
